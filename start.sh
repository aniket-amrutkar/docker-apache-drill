...
echo "drill.exec:{ cluster-id: \"$DRILL_CLUSTER\", zk.connect: \"$ZOOKEEPER\", buffer.size : \"$DRILL_EXEC_BUFFER_SIZE\", rpc.user.timeout: $DRILL_RPC_USER_TIMEOUT }" > /opt/drill/apache-drill-${DRILL_VERSION}/conf/drill-override.conf
